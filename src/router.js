...
router.post('/tasks',tasksMiddleware.validateUserId, tasksMiddleware.validateTitle, tasksController.createTask); // quando a rota for '/tasks' e POST, primeiro valida o body através do middleware, e se tudo ok, chama a função de criar uma nova task
